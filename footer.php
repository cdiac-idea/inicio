...
<footer class="clear">
      ...
      <div class="col-md-4 col-lg-4 col-sm-4 col-xs-4 col-xxs-12 footer-info">
            <p class="col-sm-6 col-md-6 contacto">
                  <b>Contacto página web:</b><br/> Carrera 27 #64-60<br/> Bloque I piso 5<br/> Manizales Caldas, Colombia<br/> 
                  linea 01 8000 916956 <br>
                  PBX: (57+6) 8879300 EXT. 50198-50317-50347
            </p>
            <p class="col-sm-6 col-md-6 derechos">
                  © Copyright<br/> Algunos derechos reservados.<br/>
                  <a title="Comuníquese con el administrador de este sitio web" href="mailto:EMAIL@unal.edu.co">idea_man@unal.edu.co</a><br/>
                  <a href="index.html#">Acerca de este sitio web</a><br/> Actualización:
            </p>
      </div>
